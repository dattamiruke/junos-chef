...
*.[0-9]*)
	...
	if test ! -f /b/dhilipkr/123_sdk_new/12.3R2.5/jpuppet/src/dist/ncurses-5.9/man_alias.sed ; then
cat >>/b/dhilipkr/123_sdk_new/12.3R2.5/jpuppet/src/dist/ncurses-5.9/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /b/dhilipkr/123_sdk_new/12.3R2.5/jpuppet/src/dist/ncurses-5.9/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /b/dhilipkr/123_sdk_new/12.3R2.5/jpuppet/src/dist/ncurses-5.9/man_alias.sed | sort -u`
	...
	sed	-f /b/dhilipkr/123_sdk_new/12.3R2.5/jpuppet/src/dist/ncurses-5.9/man_alias.sed \
		< $i >$TMP
