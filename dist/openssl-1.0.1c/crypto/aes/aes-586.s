...
.L002pic_point:
	popl	%ebp
	leal	.LAES_Te-.L002pic_point(%ebp),%ebp
	leal	764(%esp),%ebx
	subl	%ebp,%ebx
	andl	$768,%ebx
...
.L006pic_point:
	popl	%ebp
	leal	.LAES_Td-.L006pic_point(%ebp),%ebp
	leal	764(%esp),%ebx
	subl	%ebp,%ebx
	andl	$768,%ebx
	leal	2176(%ebp,%ebx,1),%ebp
...
.L009pic_point:
	popl	%ebp
	cmpl	$0,40(%esp)
	leal	.LAES_Te-.L009pic_point(%ebp),%ebp
	jne	.L010picked_te
...
.L021fast_dec_loop:
	...
	movl	%ecx,8(%esi)
	movl	%edx,12(%esi)
	jmp	.L022fast_dec_out
.align	16
.L020fast_dec_in_place:
.L023fast_dec_in_place_loop:
	movl	(%esi),%eax
	movl	4(%esi),%ebx
	movl	8(%esi),%ecx
	movl	12(%esi),%edx
	...
	subl	$16,%ecx
	movl	%ecx,40(%esp)
	jnz	.L023fast_dec_in_place_loop
.align	4
.L022fast_dec_out:
	cmpl	$0,316(%esp)
	movl	44(%esp),%edi
...
.L011slow_way:
	...
	cmpl	$16,%ecx
	movl	%ebx,%edx
	jb	.L026slow_enc_tail
.align	16
.L027slow_enc_x86:
	movl	(%edi),%eax
	movl	4(%edi),%ebx
.align	4
.L028slow_enc_loop_x86:
	movl	8(%edi),%ecx
	movl	12(%edi),%edx
	xorl	(%esi),%eax
	xorl	4(%esi),%ebx
	...
	cmpl	$16,%ecx
	movl	%ecx,40(%esp)
	jae	.L028slow_enc_loop_x86
	testl	$15,%ecx
	jnz	.L026slow_enc_tail
	movl	48(%esp),%esi
	movl	8(%edi),%ecx
	movl	12(%edi),%edx
	movl	%eax,(%esi)
...
.align	4
.long	2767451785
	jmp	.L030enc_skip_in_place
.L029enc_in_place:
	leal	(%edi,%ecx,1),%edi
.L030enc_skip_in_place:
	movl	%ebx,%ecx
	xorl	%eax,%eax
.align	4
.long	2868115081
	...
	movl	4(%edi),%ebx
	movl	$16,40(%esp)
	jmp	.L028slow_enc_loop_x86
.align	16
.L025slow_decrypt:
.align	16
.L031slow_dec_loop_x86:
	movl	(%esi),%eax
	movl	4(%esi),%ebx
	movl	8(%esi),%ecx
	movl	12(%esi),%edx
...
.L034pic_point:
	popl	%ebp
	leal	.LAES_Te-.L034pic_point(%ebp),%ebp
	leal	2176(%ebp),%ebp
	movl	-128(%ebp),%eax
	movl	-96(%ebp),%ebx
	movl	-64(%ebp),%ecx
