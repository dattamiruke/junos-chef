...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/1.9.1/i386-freebsd6.3")
  ...
  CONFIG["warnflags"] = "-Wall -Wno-unused-parameter -Wno-parentheses -Wno-long-long -Wpointer-arith -Wwrite-strings -Wdeclaration-after-statement -Werror-implicit-function-declaration"
  ...
  CONFIG["CC"] = "gcc"
  CONFIG["target_os"] = "freebsd6.3"
  CONFIG["target_vendor"] = "unknown"
  CONFIG["target_cpu"] = "i386"
  CONFIG["target"] = "i386-unknown-freebsd6.3"
  CONFIG["host_os"] = "freebsd6.3"
  CONFIG["host_vendor"] = "unknown"
  CONFIG["host_cpu"] = "i386"
  CONFIG["host"] = "i386-unknown-freebsd6.3"
  CONFIG["RUBYW_BASE_NAME"] = "rubyw"
  CONFIG["RUBY_BASE_NAME"] = "ruby"
  CONFIG["build_os"] = "freebsd6.3"
  CONFIG["build_vendor"] = "unknown"
  CONFIG["build_cpu"] = "i386"
  CONFIG["build"] = "i386-unknown-freebsd6.3"
